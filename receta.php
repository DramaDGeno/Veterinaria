...
<input type="hidden" id="id_receta" name="id_receta" class="form-control" placeholder="Id receta" maxlength="11" required>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="desc_receta" class="col-form-label"> Desc receta: <span class="text-danger">*</span> </label>
									<input type="text" id="desc_receta" name="desc_receta" class="form-control" placeholder="Desc receta" minlength="0"  maxlength="50" required>
								</div>
							</div>
						</div>
...
<script>
  ...
  function save(id_receta) {
    ...
    if (typeof id_receta === 'undefined' || id_receta < 1) { //add
      ...
      $.ajax({
        url: '<?php echo base_url("/public/receta/getOne") ?>',
        type: 'post',
        data: {
          id_receta: id_receta
        },
